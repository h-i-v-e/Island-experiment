        ...
        public static void ValidateMultiIslandSandbox()
        {
            ...
            var requestFactories =
                UnityEngine.Object.FindObjectsByType<MonoBehaviour>(
                    FindObjectsInactive.Include)
                    .Where(component => component is IIslandGenerationRequestFactory).ToArray();
            ...
            {
                throw new InvalidOperationException(
                    "The multi-island sandbox must bind its factory and environment with correctly ordered generation, unload, and discovery radii.");
            }
        }
