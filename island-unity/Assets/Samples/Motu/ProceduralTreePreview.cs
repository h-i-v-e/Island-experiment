...
{
    [ExecuteAlways]
    [UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp", sourceClassName: "ProceduralTreePreview")]
    public sealed class ProceduralTreePreview : MonoBehaviour
    {
        ...
        private void EnsureRuntimeMaterials()
        {
            ...
            ReleaseRuntimeMaterials();
            surfaceNoiseTexture = ProceduralNoiseTextures.CreateCliffNoiseTexture();
        ...
        {
            var bark = MaterialPreparation.PrepareTreeBarkTexture(BarkTextureResolution);
            barkAlbedoTexture = IslandMaterialFactory.CreateRuntimeMaterialTexture(
            ...
            try
            {
                barkHeightTexture = IslandMaterialFactory.CreateRuntimeMaterialTexture(
                    ...
                    true,
                    bark.heightR16);
                barkNormalTexture = IslandMaterialFactory.CreateRuntimeMaterialTexture(
                    ...
                    true,
                    bark.normalRgb);
                barkOcclusionTexture = IslandMaterialFactory.CreateRuntimeMaterialTexture(
