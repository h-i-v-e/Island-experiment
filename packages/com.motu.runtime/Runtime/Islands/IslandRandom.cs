...
{
    internal static class IslandRandom
    {
        ...
        internal static int SeedForCell(int factorySeed, Vector2Int worldCell)
        {
            unchecked
            {
                ...
                var islandSeed = (int)(IslandRandom.Mix(value) & 0x7fffffffu);
                return islandSeed != 0 ? islandSeed : 1;
            }
        }

        internal static float RandomPositiveFloat(System.Random random)
        {
