...
namespace Motu.Islands
{
    ...
    public sealed partial class IslandGenerator : MonoBehaviour, IWorldSurfaceQuery
    {
        ...
        private SharedNoiseTexture cliffNoiseLease, riverNoiseLease, grassNoiseLease;
        ...
        public IslandRuntime Runtime => islandRuntime;
        ...
        public IslandNavigationSettings Navigation => Profile.Navigation;
