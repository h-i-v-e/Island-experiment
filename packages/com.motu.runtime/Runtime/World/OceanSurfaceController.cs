    ...
    public sealed partial class OceanSurfaceController : MonoBehaviour
    {
        ...
        private void EnsureMaskComposer()
        {
            if (maskComposer == null)
            {
                ...
                ownsMaskComposer = maskComposer == null;
                if (ownsMaskComposer) maskComposer = gameObject.AddComponent<OceanWaveMaskComposer>();
            }
        }
        ...
        private void OnDestroy()
        {
            ...
            if (ownsMaskComposer) DestroyUnityObject(maskComposer);
