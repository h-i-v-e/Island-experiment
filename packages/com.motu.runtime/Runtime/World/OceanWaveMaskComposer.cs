...
namespace Motu.World
{
    ...
    [UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp", sourceClassName: "OceanWaveMaskComposer")]
    internal sealed class OceanWaveMaskComposer : MonoBehaviour
    {
        ...
        private void EnsureResources()
        {
            ...
            var shader = Motu.Rendering.MotuShaders.Find("Hidden/Motu/Ocean Wave Attenuation")
                ?? throw new InvalidOperationException(
                    "Could not find shader 'Hidden/Motu/Ocean Wave Attenuation'.");
            var onshoreShader = Motu.Rendering.MotuShaders.Find("Hidden/Motu/Ocean Onshore Direction")
                ?? throw new InvalidOperationException(
