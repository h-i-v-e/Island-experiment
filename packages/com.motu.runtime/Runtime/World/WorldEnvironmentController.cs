...
namespace Motu.World
{
    ...
    public sealed partial class WorldEnvironmentController : MonoBehaviour
    {
        ...
        {
            seaVisible = visible;
            ocean?.SetVisible(visible && hostState != null);
        }
        ...
        {
            hostState?.PrepareCamera(camera, ocean);
        }
        ...
        private void Update()
        {
            if (hostState == null || !IsInstalled || environmentSettings == null || cloudSettings == null)
            {
                return;
            }
        ...
        private void OnDestroy()
        {
            ...
            if (ownsOcean) DestroyUnityObject(ocean);
        ...
        private void EnsureOcean()
        {
            if (ocean == null)
            {
                ...
                ownsOcean = ocean == null;
                if (ownsOcean) ocean = gameObject.AddComponent<OceanSurfaceController>();
            }
        }
