...
{
    internal static class ProceduralNoiseTextures
    {
        ...
        internal static Texture2D CreateCloudWeatherTexture(
            byte[] rgba,
            int width,
            int height,
            string textureName)
            ...
            IslandCloudSettings clouds)
        {
            ...
            try
            {
                ...
                return CreateCloudWeatherTexture(rgba, resolution, resolution,
                    "Rust Generated World Cloud Weather Field");
            }
            finally
            {
