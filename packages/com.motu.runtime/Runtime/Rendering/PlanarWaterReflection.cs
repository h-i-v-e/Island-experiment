...
namespace Motu.Rendering
{
    ...
    [UnityEngine.Scripting.APIUpdating.MovedFrom(true, sourceNamespace: "", sourceAssembly: "Assembly-CSharp", sourceClassName: "PlanarWaterReflection")]
    public sealed class PlanarWaterReflection : MonoBehaviour
    {
        ...
        private Shader ResolveSimplifiedShader()
        {
            ...
            {
                simplifiedReflectionShader = Motu.Rendering.MotuShaders.Find(SimplifiedShaderName);
            }
