    ...
    public sealed partial class TerrainTileStreamer : MonoBehaviour
    {
            ...
            IslandPreparedBoulderCollider[][] boulderColliders = null)
        {
            ...
            forestStreamer.Initialize(
                ...
                preparedForest,
                showForests,
                (lod, key, cancellation) => ForestGridWorker.PrepareAsync(nativeOwner, worldSize, lod, key, cancellation),
